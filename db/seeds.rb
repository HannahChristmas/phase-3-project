...
park_three = Park.create(park_name: "Cuyahoga Valley National Park", description: "Not far from Cleveland and Akron, Cuyahoga Valley features over 125 miles of hiking trails. These trails span woodlands, wetlands, fields, and waterfalls. Some of the most popular hikes include The Ledges Trail, the Brandywine Gorge Loop, and Blue Hen Falls. Cuyahoga Valley Scenic Railroad offers a scenic train ride that weaves through the valley and along the river and is notorious for wildlife sightings of deer, eagles, beavers, and herons.", state_id: state_two.id)
